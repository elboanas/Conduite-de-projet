...
public class Reference {
    ...
    public
    Reference(String id, String name, String description, Price basePrice) {
    ...
    private void setName(String name) {
        if (name == null) {
            throw new ReferenceManagementException("cannot "
                    + "create reference with null name");
        }
        this.name = name;
    }
    ...
    private void setDescription(String description) {
        if (description == null) {
            throw new ReferenceManagementException("cannot "
                    + "create reference with null description");
        }
    ...
    private void setBasePrice(Price basePrice) {
        if (basePrice == null) {
            throw new ReferenceManagementException("cannot "
                    + "create reference with null basePrice");
        }
